          ...
          <div className="flex items-center gap-2 flex-wrap">
            {p.etapa === "LISTO_PARA_CERRAR" && p.estado !== "EN_TRATO" && p.estado !== "CONVERTIDO" && (
              <button
                ...
                disabled={generando}
                className="flex items-center gap-2 px-4 py-2 bg-[#B3985B] text-black text-sm font-semibold rounded-lg hover:bg-[#C9A84C] disabled:opacity-50 transition-colors"
              >
          ...
          <div className="mt-6 pt-6 border-t border-[#1a1a1a]">
            <div className="bg-[#B3985B]/5 border border-[#B3985B]/20 rounded-xl p-4 flex items-center justify-between">
              ...
              <button
                onClick={generarCotizacion}
                disabled={generando}
                className="px-4 py-2 bg-[#B3985B] text-black text-sm font-semibold rounded-lg hover:bg-[#C9A84C] disabled:opacity-50 transition-colors"
              >
                {generando ? "Generando…" : "Generar cotización →"}
              </button>
            </div>
