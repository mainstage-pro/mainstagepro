...
export async function GET(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  // react-pdf no descarga imágenes remotas de forma fiable y solo decodifica
  // JPEG/PNG. Las fotos suelen subirse como WebP/HEIC (el navegador las muestra
  // pero react-pdf no): las bajamos y normalizamos a JPEG con sharp.
