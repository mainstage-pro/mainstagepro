...
export const CONFIG_SEED = [
  ...
  { key: "plantillas.waSaludoSimple",      section: "plantillas", label: "WhatsApp — Saludo a cliente/prospecto contactado", type: "textarea", orden: 7, value: "Qué tal, NOMBRE! Excelente día, cómo estás?\nHola NOMBRE! Cómo va todo? Espero que muy bien.\nHola NOMBRE! Cómo estás? Un gusto saludarte.\nQué tal, NOMBRE! Espero que tengas un excelente día. Cómo estás?", description: "Una variante por línea. Se elige una al azar (fija por contacto) al abrir WhatsApp desde Directorio Comercial o la lista de tratos. Usa NOMBRE para el nombre del contacto." },
  { key: "plantillas.waPresentacionProspecto",section:"plantillas",label: "WhatsApp — Primer contacto a prospecto nuevo",       type: "textarea", orden: 8, value: "Hola NOMBRE! Soy Mauricio, de Mainstage Pro. Somos una empresa de producción de eventos y renta de equipo de audio, iluminación, video y más. Me encantaría platicar contigo. Tienes un momento?\nQué tal, NOMBRE! Te saluda Mauricio de Mainstage Pro, producción de eventos y renta de equipo (audio, iluminación, video y más). Me gustaría conocer tu proyecto. Cómo estás?\nHola NOMBRE! Soy Mauricio, de Mainstage Pro. Nos dedicamos a la producción de eventos y renta de equipo de audio, iluminación y video. Si estás planeando algo, con gusto te ayudo. Platicamos?", description: "Una variante por línea. Se usa solo con prospectos sin actividad previa (sin tratos/cotizaciones). Usa NOMBRE para el nombre del contacto." },
