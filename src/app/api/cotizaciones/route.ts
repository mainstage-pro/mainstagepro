  ...
  try {
    ...
    const cotizacion = await prisma.cotizacion.create({
      data: {
        ...
        pagoAnticipadoActivo: campos.pagoAnticipadoActivo ?? false,
        pagoAnticipadoFecha: campos.pagoAnticipadoFecha ?? null,
        pagoAnticipadoTexto: campos.pagoAnticipadoTexto ?? null,
        gastosProduccionActivo: campos.gastosProduccionActivo ?? false,
        gastosProduccionEsMonto: campos.gastosProduccionEsMonto ?? false,
        gastosProduccionPct: campos.gastosProduccionPct ?? 10,
        gastosProduccionMonto: campos.gastosProduccionActivo ? (campos.gastosProduccionMonto ?? 0) : 0,
        tipoBeneficio,
        aplicaIva,
        incluirChofer,
        observaciones,
