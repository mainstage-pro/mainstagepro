...
/**
 * Client-upload handler para las fotos del catálogo de tipos de servicio.
  ...
  try {
    const jsonResponse = await handleUpload({
      ...
      onUploadCompleted: async ({ blob }) => {
        console.log("[tipos-servicio/imagenes] Upload completed:", blob.url);
      },
    });
    ...
    console.error("[tipos-servicio/imagenes] Token error:", message);
