...
const CONFIG = {
  musical: {
    ...
    gallery: [
      { src: "/images/presentacion/ev-m-hero.jpg", caption: "Festival · Producción completa" },
      { src: "/images/presentacion/ev-m-01.jpg",   caption: "Concierto al aire libre · Noche" },
      { src: "/images/presentacion/ev-m-02.jpg",   caption: "Show · Lasers y producción" },
      { src: "/images/presentacion/ev-m-03.jpg",   caption: "Artista en vivo · Full stage" },
      { src: "/images/presentacion/ev-m-04.jpg",   caption: "DJ Performance · Booth y producción" },
      { src: "/images/presentacion/ev-m-05.jpg",   caption: "Escenario · Beams y efectos" },
      { src: "/images/presentacion/ev-m-06.jpg",   caption: "Crowd · Producción de luz interior" },
      { src: "/images/presentacion/ev-m-07.jpg",   caption: "DJ Set · Disco ball y confetti" },
    ],
    why: [
  ...
  social: {
    ...
    gallery: [
      { src: "/images/presentacion/ev-s-hero.jpg", caption: "Boda · Venue histórico · Producción elegante" },
      { src: "/images/presentacion/ev-s-01.jpg",   caption: "Hacienda · Iluminación de ambiente" },
      { src: "/images/presentacion/ev-s-02.jpg",   caption: "XV Años · Salón con producción" },
      { src: "/images/presentacion/ev-s-03.jpg",   caption: "Boda · Venue industrial · Luz natural" },
      { src: "/images/presentacion/ev-s-04.jpg",   caption: "Vista desde la cabina · Evento en vivo" },
      { src: "/images/presentacion/ev-s-05.jpg",   caption: "Jardín · Producción diurna elegante" },
      { src: "/images/presentacion/ev-s-06.jpg",   caption: "Hacienda · Noche · Ambient lighting" },
    ],
    why: [
  ...
  empresarial: {
    ...
    gallery: [
      { src: "/images/presentacion/ev-e-hero.jpg", caption: "Congreso · Plena capacidad · Producción AV" },
      { src: "/images/presentacion/ev-e-01.jpg",   caption: "Conferencia · Iluminación corporativa" },
      { src: "/images/presentacion/ev-e-02.jpg",   caption: "Lanzamiento exterior · Pantalla y marquee" },
      { src: "/images/presentacion/ev-e-03.jpg",   caption: "Inauguración · Iluminación arquitectónica" },
      { src: "/images/presentacion/ev-e-04.jpg",   caption: "Lanzamiento · Speaker y pantalla LED" },
      { src: "/images/presentacion/ev-e-05.jpg",   caption: "Networking · Evento en terraza corporativa" },
    ],
    why: [
