...
───────────────────────────────────────────────────────────── */
const G   = "#B89230";                        // gold
const G_A = (a: number) => `rgba(184,146,48,${a})`;
const W   = "#F0F0F0";                        // white
const W_A = (a: number) => `rgba(240,240,240,${a})`;
const GR  = "#787878";                        // gray
const BG  = "#080808";                        // background
...
function Logo({ scale = 1 }: { scale?: number }) {
  ...
  return (
    <svg width={w} height={h} viewBox="0 0 148 58" aria-label="Mainstage Pro">
      {/* Gray circle */}
      <circle cx="24" cy="25" r="22" fill={GR} opacity="0.45" />
      {/* Gold circle */}
      <circle cx="43" cy="25" r="22" fill={G} />
      {/* MAINSTAGE */}
      <text x="74" y="18"
        fontFamily={FONT} fontSize="11.5" fontWeight="700" letterSpacing="2.5" fill={W}>
        MAINSTAGE
      </text>
      {/* Thin gold line */}
      <line x1="74" y1="24" x2="146" y2="24" stroke={G} strokeWidth="0.55" />
      {/* P R O */}
      <text x="74" y="37"
        fontFamily={FONT} fontSize="9" fontWeight="300" letterSpacing="6.5" fill={G}>
        P R O
      </text>
    </svg>
  );
...
function Tag({ children, delay = 0 }: { children: React.ReactNode; delay?: number }) {
  return (
    <A delay={delay}>
      <p style={{
        color: G, fontSize: 10, fontWeight: 600,
...
function GoldLine({ delay = 0, width = 40 }: { delay?: number; width?: number }) {
  return (
    <A delay={delay}>
      <div style={{ width, height: 1.5, background: G, marginBottom: 24 }} />
    </A>
  );
}
  ...
  return (
    <A delay={delay}>
      <div style={{
        ...
        padding: "16px 0",
        borderBottom: "1px solid rgba(184,146,48,0.07)",
      }}>
        <span style={{
          flexShrink: 0, width: 30, height: 30, borderRadius: "50%",
          display: "flex", alignItems: "center", justifyContent: "center",
          background: gold ? G_A(0.15) : G_A(0.07),
          color: G, fontSize: 10, fontWeight: 700, marginTop: 1,
        }}>{n}</span>
        <div>
          <p style={{ color: W, fontWeight: 700, fontSize: 15, marginBottom: 4 }}>{title}</p>
          <p style={{ color: W_A(0.45), fontSize: 13, lineHeight: 1.6 }}>{body}</p>
        </div>
      </div>
    </A>
  );
...
function RadialGlow({ intensity = 0.05 }: { intensity?: number }) {
  return (
    <div style={{
      position: "absolute", inset: 0, pointerEvents: "none",
      background: `radial-gradient(ellipse 70% 60% at 50% 50%, ${G_A(intensity)} 0%, transparent 70%)`,
    }} />
  );
}
...
function BigNum({ n }: { n: string }) {
  return (
    <div style={{
      position: "absolute", right: "4%", bottom: "-8%",
      fontSize: "clamp(180px, 28vw, 380px)", fontWeight: 900, lineHeight: 1,
      color: G_A(0.025), letterSpacing: "-0.06em",
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "center", position: "relative", zIndex: 1, padding: "0 32px" }}>
        {/* Logo */}
        <A delay={100} style={{ display: "flex", justifyContent: "center", marginBottom: 48 }}>
          <Logo scale={1.8} />
        </A>
        ...
        <A delay={300}>
          <div style={{
            width: "55%", height: 1, margin: "0 auto 28px",
        ...
        {/* Footer */}
        <A delay={580}>
          <p style={{ color: W_A(0.2), fontSize: 11, letterSpacing: "0.3em" }}>
        ...
        <A delay={800}>
          <p style={{
            marginTop: 52, color: W_A(0.15), fontSize: 10, letterSpacing: "0.25em",
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 580, position: "relative", zIndex: 1 }}>
        <Tag delay={0}>01 — Propósito</Tag>
        <A delay={100}>
          <h1 style={{
            fontSize: "clamp(3rem, 8vw, 7rem)", fontWeight: 800, lineHeight: 0.92,
            letterSpacing: "-0.045em", color: W, marginBottom: 36,
          }}>
            Por qué<br />existimos.
          </h1>
        </A>
        <A delay={260}>
          <p style={{
            color: W_A(0.45), fontSize: "clamp(1rem, 1.8vw, 1.2rem)",
...
function Slide03() {
  return (
    <div style={{
      ...
      {/* Background photo: event */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        src="/images/presentacion/musicales/Musicales-016.jpg"
        alt=""
        draggable={false}
        style={{
      ...
      <div style={{ maxWidth: 760, position: "relative", zIndex: 1 }}>
        ...
        <A delay={120}>
          <blockquote style={{
            fontSize: "clamp(2rem, 5vw, 4rem)", fontWeight: 700, lineHeight: 1.1,
        ...
        <A delay={320}>
          <p style={{
            color: W_A(0.45), fontSize: "clamp(0.95rem, 1.6vw, 1.1rem)",
...
function Slide05() {
  ...
  return (
    <div style={{
      ...
      <A delay={180}>
        <p style={{
          color: W_A(0.45), fontSize: "clamp(0.95rem, 1.6vw, 1.05rem)",
          lineHeight: 1.65, marginBottom: 40, maxWidth: 540,
        }}>
          Potenciamos proyectos, artistas y marcas a través de la producción
          técnica impecable de sus eventos.
        </p>
      </A>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
        {cols.map((c, i) => (
          <A key={c.n} delay={280 + i * 90}>
            <div style={{
              borderRadius: 16, padding: "28px 24px",
              background: i === 0 ? G_A(0.05) : "rgba(255,255,255,0.025)",
              border: `1px solid ${i === 0 ? G_A(0.15) : "rgba(255,255,255,0.06)"}`,
              height: "100%",
            }}>
              <p style={{ color: G, fontSize: 11, fontWeight: 700, letterSpacing: "0.2em", marginBottom: 16 }}>{c.n}</p>
              <p style={{ color: W, fontWeight: 700, fontSize: 20, marginBottom: 10, letterSpacing: "-0.02em" }}>{c.title}</p>
              <p style={{ color: W_A(0.45), fontSize: 13.5, lineHeight: 1.65 }}>{c.body}</p>
            </div>
          </A>
        ))}
      </div>
...
function Slide06() {
  ...
  return (
    <div style={{
      height: "100%", display: "flex", flexDirection: "column", justifyContent: "center",
      padding: "clamp(40px, 6vh, 72px) clamp(48px, 8vw, 120px)",
    }}>
      <Tag delay={0}>Propuesta de valor</Tag>
      <A delay={80}>
        <h2 style={{
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, flex: 1, maxHeight: "50vh" }}>
        {svcs.map((s, i) => (
            ...
            <div style={{
              ...
              <div style={{ position: "relative", height: "42%", flexShrink: 0, overflow: "hidden" }}>
                ...
                <p style={{
                  ...
                  color: G, fontSize: 10, fontWeight: 700, letterSpacing: "0.22em",
                }}>{s.id}</p>
              </div>
              {/* Content */}
              <div style={{
                ...
                <p style={{ color: G, fontWeight: 700, fontSize: 15, marginBottom: 8, letterSpacing: "-0.01em" }}>{s.name}</p>
                <p style={{ color: W, fontSize: 13, lineHeight: 1.55, marginBottom: 10 }}>{s.desc}</p>
                <p style={{ color: W_A(0.3), fontSize: 11.5, lineHeight: 1.5 }}>
...
function Slide07() {
  const items = [
    {
      title: "Calidad humana y cultura de servicio",
      body: "Actitud, respeto y profesionalismo bajo presión — siempre. El cliente lo siente desde la primera llamada hasta el cierre del evento.",
    },
    {
      title: "Pasión genuina por los eventos",
      body: "Dentro de Mainstage trabajamos personas realmente apasionadas por los shows. Eso se nota en la calidad de cada entrega.",
    },
    {
      title: "Soluciones integrales de producción",
      body: "Capacidad técnica y humana para resolver cualquier necesidad — desde un equipo puntual hasta una dirección técnica completa.",
    },
    {
      title: "Ritmo y seguimiento",
      body: "Procesos claros y comunicación constante que mantienen orden y personalización en cada proyecto, sin importar su escala.",
    },
  ];
  return (
    <div style={{
      ...
      <Tag delay={0}>El estándar que representamos</Tag>
      <A delay={80}>
        <h2 style={{
          fontSize: "clamp(1.8rem, 4.5vw, 3.5rem)", fontWeight: 800,
      ...
      <div style={{
        ...
        gridTemplateRows: "1fr 1fr", gap: 14, flex: 1, maxHeight: "58vh",
      }}>
        {items.map((item, i) => (
          <A key={i} delay={160 + i * 70} style={{ height: "100%" }}>
            <div style={{
              ...
              border: `1px solid ${i % 2 === 0 ? G_A(0.14) : "rgba(255,255,255,0.06)"}`,
            }}>
              <p style={{ color: W, fontWeight: 700, fontSize: 15, marginBottom: 10, letterSpacing: "-0.01em" }}>{item.title}</p>
              <p style={{ color: W_A(0.42), fontSize: 13, lineHeight: 1.65 }}>{item.body}</p>
            </div>
          </A>
        ))}
      </div>
...
function Slide09() {
  ...
  return (
    <div style={{
      ...
      <Tag delay={0}>Principios rectores</Tag>
      <A delay={80}>
        <h2 style={{
          fontSize: "clamp(1.8rem, 4.5vw, 3.5rem)", fontWeight: 800,
          letterSpacing: "-0.035em", color: W, marginBottom: 28,
        ...
        {rules.map((r, i) => (
          <A key={r.n} delay={160 + i * 80}>
            <div style={{
              ...
              <span style={{
                color: G_A(0.35), fontSize: 11, fontWeight: 700,
                letterSpacing: "0.1em", flexShrink: 0,
              }}>{r.n}</span>
              <span style={{
                color: W, fontSize: "clamp(1rem, 2vw, 1.4rem)",
                fontWeight: 600, letterSpacing: "-0.015em", lineHeight: 1.35,
              }}>{r.rule}</span>
            </div>
          </A>
        ))}
...
function Slide11() {
  const pillars = [
    {
      title: "Confiabilidad",
      body: "El cliente sabe que con Mainstage el show funciona. Esa certeza es nuestra reputación — la construimos en cada evento.",
    },
    {
      title: "Altura Técnica",
      body: "Operamos al nivel que los proyectos merecen. No improvisamos, no cortamos esquinas, no aceptamos menos de lo mejor que podemos dar.",
    },
    {
      title: "Presencia Profesional",
      body: "Somos el espejo de la empresa en cada producción. La forma en que nos presentamos y trabajamos es la imagen de Mainstage.",
    },
  ];
  return (
    <div style={{
      ...
      <Tag delay={0}>La marca</Tag>
      <A delay={80}>
        <h2 style={{
          fontSize: "clamp(1.6rem, 3.8vw, 3rem)", fontWeight: 800,
          letterSpacing: "-0.03em", color: W, marginBottom: 40, maxWidth: 580,
        }}>
        ...
        {pillars.map((p, i) => (
          <A key={p.title} delay={200 + i * 100} style={{ height: "100%" }}>
            <div style={{
              ...
              background: G_A(0.045), border: `1px solid ${G_A(0.14)}`,
              display: "flex", flexDirection: "column",
            }}>
              <div style={{ width: 36, height: 1.5, background: G, marginBottom: 22 }} />
              <p style={{
                color: G, fontWeight: 800, fontSize: 11, letterSpacing: "0.22em",
                textTransform: "uppercase", marginBottom: 16,
              }}>{p.title}</p>
              <p style={{ color: W_A(0.5), fontSize: 14, lineHeight: 1.7 }}>{p.body}</p>
            </div>
          </A>
        ))}
      </div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          position: "absolute", inset: 0, pointerEvents: "none",
          background: `radial-gradient(ellipse 80% 80% at 20% 50%, ${G_A(0.04)} 0%, transparent 70%)`,
        }} />
        <Tag delay={0}>Mentalidad Mainstage</Tag>
        <A delay={100}>
          <h2 style={{
            fontSize: "clamp(2rem, 4.5vw, 3.8rem)", fontWeight: 800,
            letterSpacing: "-0.04em", lineHeight: 1.0, color: W,
          }}>
            "No solo<br />ejecutas.<br />
            <span style={{ color: G }}>Construyes."</span>
          </h2>
        </A>
      </div>
        ...
        {points.map((p, i) => (
          <A key={i} delay={150 + i * 90}>
            <div style={{
              ...
              <p style={{ color: W_A(0.5), fontSize: 14.5, lineHeight: 1.65 }}>{p}</p>
            </div>
          </A>
        ))}
      </div>
...
function Slide13() {
  return (
    <div style={{
      ...
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        src="/images/presentacion/musicales/Afrodise-59.jpg"
        alt=""
        draggable={false}
        style={{
          position: "absolute", inset: 0, width: "100%", height: "100%",
      ...
      <div style={{
        position: "absolute", inset: 0, pointerEvents: "none",
        background: `radial-gradient(ellipse 80% 70% at 50% 50%, ${G_A(0.07)} 0%, transparent 65%)`,
      }} />
      <PulseRings />
      ...
      <div style={{ textAlign: "center", position: "relative", zIndex: 1, padding: "0 32px" }}>
        <A delay={0}>
          <p style={{
            color: W_A(0.25), fontSize: "clamp(0.9rem, 2vw, 1.2rem)",
            fontWeight: 200, letterSpacing: "0.35em", textTransform: "uppercase", marginBottom: 16,
          }}>
            Esto es
          </p>
          <h1 style={{
            fontSize: "clamp(4rem, 12vw, 11rem)", fontWeight: 900, lineHeight: 0.85,
        ...
        <A delay={420}>
          <p style={{
            color: W_A(0.3), fontSize: "clamp(0.75rem, 1.4vw, 0.95rem)",
        ...
        <A delay={580}>
          <p style={{ color: W_A(0.12), fontSize: 13, letterSpacing: "0.04em", marginTop: 20 }}>
            Esto es lo que representamos. Esto es lo que construimos juntos.
          </p>
        </A>

        <A delay={780} style={{ display: "flex", justifyContent: "center", marginTop: 44 }}>
          <Logo scale={0.9} />
        </A>
      </div>
    </div>
...
export default function PresentacionEquipoClient() {
  ...
  return (
    ...
    >
      ...
      {/* ── Logo — fixed top-left (hidden on slide 1) ── */}
      <div style={{
        position: "fixed", top: 18, left: 24, zIndex: 100,
        opacity: slide > 0 ? 0.55 : 0,
      ...
      <div style={{
        ...
        <span style={{ color: G, fontSize: 12, fontWeight: 700, letterSpacing: "0.05em" }}>
          {String(slide + 1).padStart(2, "0")}
        </span>
        <span style={{ color: W_A(0.2), fontSize: 11 }}>/</span>
        <span style={{ color: W_A(0.2), fontSize: 11 }}>{TOTAL}</span>
      </div>
      ...
      {slide > 0 && (
        <button
          ...
          style={{
            ...
            width: 40, height: 40, cursor: "pointer", color: W_A(0.4),
      ...
      <div style={{
        ...
        {Array.from({ length: TOTAL }, (_, i) => (
          <button
            ...
            style={{
              width: i === slide ? 22 : 5, height: 5, borderRadius: 3,
