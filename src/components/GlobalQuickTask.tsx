  ...
  return (
    <>
      ...
      <button
        ...
        title="Crear tarea (⌘K)"
        className="fixed bottom-6 right-6 z-[90] flex items-center gap-2 px-4 py-2.5 bg-[#B3985B] text-black text-sm font-semibold rounded-xl shadow-lg shadow-[#B3985B]/20 hover:bg-[#c9aa6a] active:scale-95 transition-all"
      >
