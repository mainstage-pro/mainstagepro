...
// Primitivas visuales compartidas por las presentaciones de galería (hub + tipo).
export const GOLD = "#B3985B";

// Aparición al hacer scroll. Se desconecta tras la primera vez.
...
// Galería masonry con lightbox (grid de columnas + modal a pantalla completa).
// Compartida por el hub combinado y por cada galería de tipo de evento.
export function Masonry({ fotos }: { fotos: GaleriaFoto[] }) {
