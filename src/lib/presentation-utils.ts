...
export const MS_CSS = `<style id="ms-framework">
/* ── Reset ── */
...
.ms-gallery{display:grid;gap:8px;width:100%;flex:1;min-height:0}
.ms-gallery img{width:100%;height:100%;object-fit:cover;border-radius:8px;display:block}
.ms-gallery.cols-1{grid-template-columns:1fr}
.ms-gallery.cols-2{grid-template-columns:1fr 1fr}
.ms-gallery.cols-3{grid-template-columns:1fr 1fr 1fr}
...
<meta name="ms-patch" content="${patchEndpoint}">`;
