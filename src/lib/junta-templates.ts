    ...
    agendaItems: [
      {
        ...
        tipo: "APERTURA",
        titulo: "Introducción",
        descripcion: "¿Cómo les fue el fin de semana? Mauricio abre la junta. Tono y energía positivos para arrancar la semana.",
        placeholder: "Notas de apertura e introducción:",
      },
      {
        orden: 2,
        tipo: "EVENTOS_SEMANA",
        titulo: "Eventos del fin de semana pasado",
        descripcion: "Recap de los eventos recientes. Tú comunicas: nombre del evento, venue, quién estuvo, si hubo algo relevante.",
        placeholder: "Notas sobre eventos del fin de semana:",
      },
      {
        orden: 3,
        tipo: "PRIORIDADES_SEMANA",
        titulo: "Eventos próximos",
        descripcion: "¿Qué eventos tenemos esta semana y las próximas? Mauricio marca qué requiere atención especial.",
        placeholder: "Notas sobre eventos próximos:",
      },
      {
        orden: 4,
        tipo: "AVISO",
        titulo: "Enfoque de la semana",
        descripcion: "El enfoque principal. Hacia dónde rema todo el equipo esta semana. Una dirección clara.",
        placeholder: "Enfoque principal de la semana:",
      },
      {
        orden: 5,
        tipo: "RECONOCIMIENTO",
        titulo: "Reconocimientos",
        descripcion: "Máx 2. Nombre + logro específico. Breve y genuino. Individual o grupal.",
      ...
      },
      {
        ...
        descripcion: "Cambios de proceso, fechas importantes, nuevos clientes, actualizaciones de plataforma.",
