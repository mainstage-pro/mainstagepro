...
export const TIPOS_EVENTO_MUESTRA: TiposEventoData = {
  ...
  tipos: [
    ...
    },
    {
      ...
      tituloGold: "OTROS",
      tituloWhite: "EVENTOS",
      descripcion: "Deporte, teatro, comedia y medios: producción a la medida.",
      nichos: ["Evento deportivo", "Comedia / Stand-up", "Teatro y artes escénicas", "Rueda de prensa", "Evento cultural", "Evento religioso"],
